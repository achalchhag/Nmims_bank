...
public class DatabaseDriver {
    ...
    // Method returns  savings account
    ...
    * */
    ...
    public void updateCheckingAccountBalance(String pAddress, double newBalance) {
        Statement statement;
        try {
            statement = this.conn.createStatement();
    ...
    public void updateSavingsAccountBalance(String pAddress, double newBalance) {
        Statement statement;
        try {
            statement = this.conn.createStatement();
            statement.executeUpdate("UPDATE SavingsAccounts SET Balance = " + newBalance + " WHERE Owner='" + pAddress + "';");
    ...
    public void deleteClient(String pAddress) {
        ...
        try {
            statement = this.conn.createStatement();
            // Delete from accounts first (foreign key references)
